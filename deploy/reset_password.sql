-- Deploy postgraphile_user_system:reset_password to pg
-- requires: users
...
CREATE OR REPLACE FUNCTION reset_password (  user_id uuid,   reset_token text,   new_password text) RETURNS boolean AS
$$
declare
